...
# create text box
my_text = Text(my_frame, width=80, height=20, font=("cursive", 16), selectbackground="black",
               selectforeground="red", undo=True,
...
# text color
color_icon = ImageTk.PhotoImage(Image.open("icons/color.jpg").resize((18,18), Image.LANCZOS))
